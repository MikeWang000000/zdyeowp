...
curl -fO 'https://mirrors.tuna.tsinghua.edu.cn/kernel/v6.x/linux-6.13.tar.xz'
...
curl -fO 'https://mirrors.tuna.tsinghua.edu.cn/gnu/binutils/binutils-2.44.tar.xz'
...
# GCC (compiler)
cd "$BUILDDIR"
curl -fO 'https://mirrors.tuna.tsinghua.edu.cn/gnu/gcc/gcc-14.2.0/gcc-14.2.0.tar.xz'

tar xf gcc-14.2.0.tar.xz
cd gcc-14.2.0

curl -fO "https://mirrors.tuna.tsinghua.edu.cn/gnu/gmp/gmp-6.3.0.tar.xz"
curl -fO "https://mirrors.tuna.tsinghua.edu.cn/gnu/mpfr/mpfr-4.2.1.tar.xz"
curl -fO "https://mirrors.tuna.tsinghua.edu.cn/gnu/mpc/mpc-1.3.1.tar.gz"
...
# GLIBC (headers)
cd "$BUILDDIR"
curl -fO 'https://mirrors.tuna.tsinghua.edu.cn/gnu/glibc/glibc-2.41.tar.xz'
